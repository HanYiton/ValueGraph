...
pretrain_path = 'workspace/baseline/GraphMae2/checkpoints/gat_gat_512_2_social_0.5_512_checkpoint.pt'
dataset_name = 'social'
...
ego_graphs_file_path = f"workspace/baseline/GraphMae2/lc_ego_graphs/{dataset_name}/graphs.pt"
