...
class BotRGCN_512(nn.Module):
    def __init__(self,des_size=768,tweet_size=512,num_prop_size=5,cat_prop_size=3,embedding_dimension=128,dropout=0.3):
        super(BotRGCN_512, self).__init__()
...
class BotGCN_512(nn.Module):
    def __init__(self,des_size=768,tweet_size=512,num_prop_size=5,cat_prop_size=3,embedding_dimension=128,dropout=0.3):
        super(BotGCN_512, self).__init__()
        self.dropout = dropout
        self.linear_relu_des=nn.Sequential(
            nn.Linear(des_size,int(embedding_dimension/4)),
            nn.LeakyReLU()
...
class BotGAT_512(nn.Module):
    def __init__(self,des_size=768,tweet_size=512,num_prop_size=5,cat_prop_size=3,embedding_dimension=128,dropout=0.3):
        super(BotGAT_512, self).__init__()
        self.dropout = dropout
        self.linear_relu_des=nn.Sequential(
            nn.Linear(des_size,int(embedding_dimension/4)),
            nn.LeakyReLU()
