...
import torch
from dataset_new import get_train_data
from torch_geometric.loader import NeighborLoader
from tqdm import tqdm
import torch.nn as nn
from model_new import BotGAT, BotGCN, BotRGCN
import time
...
def train():
    ...
    os.makedirs("checkpoints_our", exist_ok=True)
    test_metrics = validation(max_epoch, 'test', model, loss_fn, test_loader)
    torch.save(best_state_dict, 'checkpoints_our/{}_{}.pt'.format(dataset_name, test_metrics['acc']))
